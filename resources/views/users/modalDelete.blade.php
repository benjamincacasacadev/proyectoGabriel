        ...
        <div class="w-100">
            <div class="row">
                <div class="col-lg-12 mb-3">
                    <button type="submit" class="btn btn-danger w-100 font-weight-bold" name="btnEliminar">Entiendo, eliminar usuario</button>
                </div>
                <div class="col-lg-12 ">
                    <a class="au-btn btn-outline-secondary border border-secondary w-100 text-center font-weight-bold" data-dismiss="modal">
                        Cancelar
                    </a>
                </div>
            </div>
