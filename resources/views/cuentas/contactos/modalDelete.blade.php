{{Form::open(array('action'=>array('ContactosCuentasController@destroy',code($contacto->id)),'method'=>'post', 'onsubmit'=>'botonEliminar.disabled = true; return true;'))}}
    ...
    <div class="modal-body text-center py-4 px-4">
        ...
        @if($cantAsociados > 0)
            ...
            <h6>No puede eliminar el contacto <b>{{ $contacto->nombre_contacto }}</b> </h6>
            <div class="text-muted">
                El contacto tiene {{ $cantAsociados }} registro(s) asociados.
            </div>
        @else
            ...
            <div class="text-muted">
                ¿Está seguro de eliminar el contacto <b>{{ $contacto->nombre_contacto }}</b>?
            </div>
        @endif
    </div>
