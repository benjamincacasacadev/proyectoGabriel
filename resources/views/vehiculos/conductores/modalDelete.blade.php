{{Form::open(array('action'=>array('ConductoresVehiculosController@destroy',code($conductor->id)),'method'=>'post', 'onsubmit'=>'botonEliminar.disabled = true; return true;'))}}
    ...
    <div class="modal-body text-center py-4 px-4">
        ...
        @if($cantAsociados > 0)
            ...
            <h6>No puede eliminar el conductor <b>{{ $conductor->nombre_conductor }}</b> </h6>
            <div class="text-muted">
                El conductor esta asociado a {{ $cantAsociados }} novedad(es).
            </div>
        @else
            ...
            <div class="text-muted">
                ¿Está seguro de eliminar el conductor <b>{{ $conductor->nombre_conductor }}</b>?
            </div>
        @endif
    </div>
